{
  ...
  inputs = {
    ...
    # Only used for emacs packages; Used because of the mess that is
    # elpa packaging on 21.05, fixed in unstable:
  ...
  outputs = { nixpkgs, nixpkgs-unstable, home-manager, nurpkgs, flake-utils
    , nvfetcher, ... }:
    let
      overlays = [
        (final: prev: {
